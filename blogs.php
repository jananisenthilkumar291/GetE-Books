		...
		<?php 
			...
			while($row = mysqli_fetch_assoc($result)){
				...
				<div class="card" style="width:18rem;margin:5%;border-radius:70px;background-color:lightgrey;border:0px;">
				  <img class = "card-img-top p-0 shadow" src = "<?php echo $blog_image;?>" style = "border-radius:70px;" alt = "Card image cap">
				  <div class="card-body">
					<h5 class="card-title"><?php echo $blog_title;?></h5>
					<h6 class="card-subtitle mb-2 text-muted"><?php echo $blog_desc?></h6>
					<a href="blog.php?id=<?php echo $blog_id;?>" class="card-link">Open Blog</a>
				  </div>
				</div>
				<?php
			}
